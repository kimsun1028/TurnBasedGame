...
namespace TurnBasedGame
{
    ...
    {
        public Slime(string name) : base(name, 100, 30) 
        {
        this.Job = "슬라임";
        }
        ...
        public void BasicAttack()
        {
            ...
            if (target != null)
            {
                Console.WriteLine($"{Name}이(가) 기본 공격으로 {target.Name}에게 {Power}만큼 피해를 입힙니다!");
        ...
        public override void Skill()
        {
            ...
            if (Field.alliesAlive.Count < 2)
            {
                ...
                if (only != null)
                {
                    Console.WriteLine($"{Name}이(가) 슬라임 난사를 사용했지만 대상이 1명뿐입니다!");
            ...
            else if (Field.isTaunt)
            {
                ...
                Console.WriteLine($"{Name}이(가) 슬라임 난사를 사용했지만 아군이 도발중입니다!");
            ...
            else
            {
                ...
                Console.WriteLine($"{Name}이(가) 스킬 : 슬라임 난사로 {target1.Name}와(과) {target2.Name}에게 각각{Power}만큼 피해를 입힙니다!");
